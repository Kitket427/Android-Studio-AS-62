...
public class MainActivity extends Activity {
    ...
    void fillData() {
        for (int i = 1; i <= 2; i++) {
            products.add(new Product("Hello Kitty", i * 14,
                    R.drawable.a1, false));
            products.add(new Product("Pochacko", i * 15,
                    R.drawable.mers, false));
            products.add(new Product("My Melody ", i * 15,
                    R.drawable.haval, false));
            products.add(new Product("Cinemaroll", i * 15,
                    R.drawable.bomba, false));
            products.add(new Product("Kuromi", i * 20,
