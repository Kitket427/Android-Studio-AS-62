...
public class MainActivity extends Activity {
    ...
    void fillData() {
        for (int i = 1; i <= 2; i++) {
            products.add(new Product("Белая машинка " + i, i * 1000,
                    R.drawable.a1, false));
            products.add(new Product("Черный гелик " + i, i * 1000,
                    R.drawable.mers, false));
            products.add(new Product("Серая машинка " + i, i * 1000,
                    R.drawable.haval, false));
            products.add(new Product("Красивая машинка " + i, i * 1000,
                    R.drawable.bomba, false));
            products.add(new Product("Спортивная машинка " + i, i * 1000,
