...
public class gallery extends AppCompatActivity implements GestureOverlayView.OnGesturePerformedListener{
    ...
    private Integer[] pictures = {R.drawable.e, R.drawable.two, R.drawable.three, R.drawable.f,
            R.drawable.fi,R.drawable.s,R.drawable.se,R.drawable.one,R.drawable.ni};
