...
public class MainActivity extends AppCompatActivity {
    ...
    void createViewPagerAndTabLayout()
    {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Your notes"));
        tabLayout.addTab(tabLayout.newTab().setText("Add note"));
        tabLayout.addTab(tabLayout.newTab().setText("Delete note"));
        tabLayout.addTab(tabLayout.newTab().setText("Change note"));
